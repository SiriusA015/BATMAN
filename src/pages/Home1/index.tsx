import HeroImg from "../../assets/images/new/back1.png";
...
import Man1 from "../../assets/images/new/avatar2.png";
import Man2 from "../../assets/images/new/avatar2.png";
      ...
      <div className="w-full h-full relative">
        <div className="w-full xl:px-[100px] lg:px-[80px] md:px-[40px] px-[20px]">
          ...
          <div className="mt-[20px] font-[400] 2xl:text-[16px] xl:text-[14px] text-[12px] text-[#eeeeee]">
            One of the most iconic fictional characters in the world, Superman
            has
            <br></br>
          ...
          <div className="2xl:w-[290px] xl:w-[260px] lg:w-[220px] w-[180px] 2xl:h-[57px] xl:h-[52px] lg:h-[48px] h-[42px] 2xl:mt-[50px] xl:mt-[42px] md:mt-[33px] mt-[24px] rounded-[10px] bg-[#B999C8] font-[550] 2xl:text-[26px] lg:text-[24px] text-[22px] text-black flex justify-center items-center cursor-pointer hover:shadow-2xl hover:scale-[1.02] transition duration-500">
            $ Buy BM
          </div>
          <div className="lg:mt-[25px] mt-[18px] flex gap-[10px]">
            <div className="bg-[#B999C8] 2xl:w-[56px] xl:w-[50px] lg:w-[45px] w-[40px] 2xl:h-[56px] xl:h-[50px] lg:h-[45px] h-[40px] flex justify-center items-center cursor-pointer rounded-l-[7px]">
              <img alt="Telegram" src={Telegram} />
            </div>
            <div className="bg-[#B999C8] 2xl:w-[56px] xl:w-[50px] lg:w-[45px] w-[40px] 2xl:h-[56px] xl:h-[50px] lg:h-[45px] h-[40px] flex justify-center items-center cursor-pointer">
              <img alt="Instagram" src={Instagram} />
            </div>
            <div className="bg-[#B999C8] 2xl:w-[56px] xl:w-[50px] lg:w-[45px] w-[40px] 2xl:h-[56px] xl:h-[50px] lg:h-[45px] h-[40px] flex justify-center items-center cursor-pointer rounded-r-[7px]">
        ...
        <div
          className={`w-full lg:flex justify-center items-center bg-black xl:px-[100px] lg:px-[80px] md:px-[40px] px-[20px] pt-[-215px] ${
            isDesktop
              ? "mt-[360px]"
        ...
        <div className="w-full lg:flex bg-black xl:px-[100px] lg:px-[80px] md:px-[40px] px-[20px] lg:pt-[78px]">
          <div className="lg:w-[30%] flex items-center justify-center">
            <img
              alt="man2"
              src={Man2}
              className="2xl:w-[500px] xl:w-[450px] lg:w-[420px] md:w-[360px] w-[280px] 2xl:h-[600px] xl:h-[550px] h-[500px]"
            />
          </div>
          <div className="lg:w-[70%] lg:mt-0 mt-[80px] flex flex-col items-center">
            ...
            <div
              className="lg:mt-[40px] mt-[20px] rounded-[30px] flex justify-center items-center 2xl:w-[766px] xl:w-[700px] lg:w-[650px] md:w-[600px] sm:w-[400px] w-[300px]  2xl:h-[400px] lg:h-[360px] md:h-[320px] h-[280px]"
              style={{
                background:
